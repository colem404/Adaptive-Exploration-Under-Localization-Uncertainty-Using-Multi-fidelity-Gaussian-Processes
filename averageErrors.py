...
i=0
print(d.dtype.names[10],"=",i)
index=d[d.dtype.names[10]]==i
print(d.dtype.names[1],np.mean(d[d.dtype.names[1]][index]))
print(d.dtype.names[2],np.mean(d[d.dtype.names[2]][index]))
print(d.dtype.names[3],np.mean(d[d.dtype.names[3]][index]))
print(d.dtype.names[4],np.mean(d[d.dtype.names[4]][index]))

print(d.dtype.names[6],np.mean(d[d.dtype.names[6]][index]))
print(d.dtype.names[7],np.mean(d[d.dtype.names[7]][index]))
print(d.dtype.names[8],np.mean(d[d.dtype.names[8]][index]))
print(d.dtype.names[9],np.mean(d[d.dtype.names[9]][index]))
